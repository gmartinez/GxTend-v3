...
var labels = [];
var _CURRENT_LNG_ = $.cookie("gxtend_login_language");
...
function initRichTextEditor(instName,tbarName) {
    ...
    var langName = $.cookie("gxtend_login_language") ? $.cookie("gxtend_login_language") : "en";

    $("#"+instName).ckeditor(function() {}, {toolbar : tbarName, language: langName});
...
function setLang(lng) {
    ...
    $.cookie("gxtend_login_language", lng, {expires: 30, path: '/'});
